...
namespace GME1003GoblinDanceParty
{
    public class Game1 : Game
    {
        ...
        private List<Color> _starsColor;                            // list of star color
        private Texture2D _background;                         //the party background
        ...
        protected override void Initialize()
        {
            ...
            for (int i = 0; i < _numStars; i++)
            {
                _starsColor.Add(new Color(110 + _rng.Next(0, 129),80 + _rng.Next(0, 129),180 + _rng.Next(0, 129)));   // srats color range
            }
            ...
            for (int i=0;i<_numStars;i++)
            {
                _starsScale.Add(_rng.Next(5, 26)/100f);                   //size value between 0.05f - 0.25f!   
            }
        ...
        protected override void LoadContent()
        {
            ...
            _starSprite = Content.Load<Texture2D>("star");                        //my star

            _background = Content.Load<Texture2D>("partybg");                //my picture
            ...
            MediaPlayer.Play(music);                   // I like this music I will keep this
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.Draw( _background,new Rectangle (0,0,800,510),Color.White);
